...
public class OAuth2AccessTokenCreateReqDTO implements Serializable {
    ...
    @Schema(description = "用户名", requiredMode = Schema.RequiredMode.NOT_REQUIRED, example = "20")
    ...
    @Schema(description = "客户端编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "eapyuanma")
