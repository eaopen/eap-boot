...
import org.openea.eap.extj.base.mapper.ModuleMapper;
...
@Service
public class NullModuleService extends SuperServiceImpl<ModuleMapper, ModuleEntity> implements ModuleService {
    @Override
    ...
    @Override
    public ModuleMapper getBaseMapper() {
        return null;
    }
