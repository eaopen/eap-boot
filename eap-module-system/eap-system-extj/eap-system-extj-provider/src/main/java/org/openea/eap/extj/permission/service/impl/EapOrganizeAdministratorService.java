...
import org.openea.eap.extj.permission.mapper.ExtjOrganizeAdministratorMapper;
...
@Service
public class EapOrganizeAdministratorService extends SuperServiceImpl<ExtjOrganizeAdministratorMapper, OrganizeAdministratorEntity> implements OrganizeAdministratorService {
    /**
     * 获取 机构分级管理员信息
     *
     * @param userId
     ...
     */
    @Override
    public ExtjOrganizeAdministratorMapper getBaseMapper() {
        return null;
    }
