...
import org.openea.eap.extj.permission.mapper.ExtjAuthorizeMapper;
...
@Service
public class EapAuthorizeService extends SuperServiceImpl<ExtjAuthorizeMapper,AuthorizeEntity> implements AuthorizeService {
    @Override
     ...
     */
    @Override
    public ExtjAuthorizeMapper getBaseMapper() {
        return null;
    }
