...
//    private SmsTemplateService smsTemplateService;
    ...
    @Autowired
    private ExtnOauthConfig extnOauthConfig;
//    @Autowired
                                    ...
                                    for(String toUserId : toUserIdsList) {
                                        ...
                                        if(templateConfigEntity != null){
                                            ...
                                            if (!"1".equals(templateConfigEntity.getTemplateType())) {
                                                ...
                                                //流程审批页面链接地址
                                                //流程审批页面链接地址
                                                String pcLink = extnOauthConfig.getExtnFrontDomain()+"/workFlowDetail?config=" + encode;
                                                appLink = extnOauthConfig.getExtnAppDomain()+"/pages/workFlow/flowBefore/index?config="+encode;
                                                //转换为短链
                                                ...
                                                String link = extnOauthConfig.getExtnDomain() +"/api/message/ShortLink/" + shortLink;
