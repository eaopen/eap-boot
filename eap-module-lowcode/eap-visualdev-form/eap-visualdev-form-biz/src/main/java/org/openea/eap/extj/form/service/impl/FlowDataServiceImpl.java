...
public class FlowDataServiceImpl implements FormDataService {
	 ...
	 */
	@Override
	public JSONObject precheckData(JSONObject configJson, Map<String, Object> mapI18nParam, Map<String, Integer> havaDefaultCurrentValue) {
		...
		if(fieldsObj != null) {
			...
			if(fieldsList != null && !fieldsList.isEmpty()) {
				...
				// i18n filed label/tipLabel/placeholder
				// set default value
				setI18nAndDefaultCurrentValue( fieldsList, "add",mapI18nParam,havaDefaultCurrentValue, userInfo);
//				setDefaultCurrentValue(havaDefaultCurrentValue, fieldsList, userInfo, "add");
		...
		if(searchObj != null) {
			...
			if(searchList != null && !searchList.isEmpty()) {
				...
				// i18n filed label/tipLabel/placeholder
				// set default value
				setI18nAndDefaultCurrentValue( searchList, "search",mapI18nParam,havaDefaultCurrentValue, userInfo);
		...
		if(columnListObj != null) {
			...
			if(columnList != null && !columnList.isEmpty()) {
				...
				// i18n filed label/tipLabel/placeholder
				// set default value
				setI18nAndDefaultCurrentValue( columnList, "add",mapI18nParam,havaDefaultCurrentValue, userInfo);
	...
	void setI18nAndDefaultCurrentValue( List<Map<String, Object>> itemList,  String parseFlag,Map<String, Object>  mapI18nParam,Map<String, Integer> havaDefaultCurrentValue, UserInfo userInfo){
		for(int i = 0, len = itemList.size(); i < len; i++) {
			...
			if(childrenList != null && !childrenList.isEmpty()) {
				...
				setI18nAndDefaultCurrentValue(childrenList, parseFlag, mapI18nParam,havaDefaultCurrentValue,userInfo);
			...
			if("userSelect".equals(extnKey) && "true".equals(defaultCurrent)) {
			...
			} else if("depSelect".equals(extnKey) && "true".equals(defaultCurrent)) {
				String selectType = String.valueOf(itemMap.get("selectType"));
				String formId = String.valueOf(configMap.get("formId"));
				String vModel = String.valueOf(itemMap.get("__vModel__"));
				Integer inited = havaDefaultCurrentValue.get(formId + "____" + vModel);
