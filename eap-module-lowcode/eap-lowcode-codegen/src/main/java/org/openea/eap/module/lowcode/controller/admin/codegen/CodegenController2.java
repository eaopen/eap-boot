...
public class CodegenController2 {
    ...
    @PreAuthorize("@ss.hasPermission('lowcode:codegen:query')")
    ...
    @PreAuthorize("@ss.hasPermission('lowcode:codegen:create')")
    public CommonResult<List<Long>> createCodegenList(@Valid @RequestBody CodegenCreateListReqVO reqVO) {
        return CommonResult.success(codegenService.createCodegenList(SecurityFrameworkUtils.getLoginUserId(), reqVO));
    }

    @Operation(summary = "更新数据库的表和字段定义")
    @PutMapping("/update")
    @PreAuthorize("@ss.hasPermission('lowcode:codegen:update')")
    ...
    @Parameter(name = "tableId", description = "表编号", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('lowcode:codegen:delete')")
    ...
    @GetMapping("/preview")
    @Parameter(name = "tableId", description = "表编号", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('lowcode:codegen:preview')")
    ...
    @GetMapping("/download")
    @Parameter(name = "tableId", description = "表编号", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('lowcode:codegen:download')")
