...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "io.github.eaopen";
    private static final String ARTIFACT_ID = "eap";
    private static final String PACKAGE_NAME = "org.openea.eap";
    private static final String TITLE = "企业应用平台EAP";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "io.github.eaopen";
        String artifactIdNew = "eap";
        String packageNameNew = "org.openea.eap";
        String titleNew = "企业应用平台EAP";
        String projectBaseDirNew = projectBaseDir.substring(0, projectBaseDir.lastIndexOf("/")) + "/eap-new1"; // 一键改名后，“新”项目所在的目录
