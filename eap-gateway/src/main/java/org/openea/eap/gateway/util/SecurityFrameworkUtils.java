package org.openea.eap.gateway.util;

import cn.hutool.core.map.MapUtil;
import org.openea.eap.framework.common.util.json.JsonUtils;
import org.openea.eap.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from eap-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 */
@Slf4j
