package org.openea.eap.module.infra.framework.file.core.client.s3;

import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.http.HttpUtil;
import org.openea.eap.module.infra.framework.file.core.client.AbstractFileClient;
import io.minio.*;
 ...
 *
 */
public class MinioFileClient extends AbstractFileClient<S3FileClientConfig> {

    private MinioClient client;

    public MinioFileClient(Long id, S3FileClientConfig config) {
        super(id, config);
    }
