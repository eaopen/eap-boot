...
| 【精简版】[eap-boot-mini](https://gitee.com/eapcode/eap-boot-mini) | [`master`](https://gitee.com/eapcode/eap-boot-mini/tree/master/) 分支   | [`master-jdk17`](https://gitee.com/eapcode/eap-boot-mini/tree/master-jdk17/) 分支   |
...
**EAP**，以开发者为中心，打造中国第一流的快速开发平台，全部开源，个人与企业可 100% 免费使用。
...
| `eap-module-erp`    | ERP 系统的 Module 模块  |
| `eap-module-crm`    | CRM 系统的 Module 模块  |
| `eap-module-ai`     | AI 大模型的 Module 模块  |
...
| [Druid](https://github.com/alibaba/druid)                                                   | JDBC 连接池、监控组件    | 1.2.23         | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?eap) |
| [MyBatis Plus](https://mp.baomidou.com/)                                                    | MyBatis 增强工具包    | 3.5.7          | [文档](http://www.iocoder.cn/Spring-Boot/MyBatis/?eap)         |
...
| [Redisson](https://github.com/redisson/redisson)                                            | Redis 客户端        | 3.32.0         | [文档](http://www.iocoder.cn/Spring-Boot/Redis/?eap)           |
...
| [Spring Security](https://github.com/spring-projects/spring-security)                       | Spring 安全框架      | 5.7.11         | [文档](http://www.iocoder.cn/Spring-Boot/Spring-Security/?eap) |
...
| [Springdoc](https://springdoc.org/)                                                         | Swagger 文档       | 1.7.0          | [文档](http://www.iocoder.cn/Spring-Boot/Swagger/?eap)         |
...
| [Lombok](https://projectlombok.org/)                                                        | 消除冗长的 Java 代码    | 1.18.34        | [文档](http://www.iocoder.cn/Spring-Boot/Lombok/?eap)          |
