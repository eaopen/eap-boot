...
public class ObmpClientService {
    ...
    @Value("${eap.obpm.signPassword:eap}")
    private String obpmSignPassword;

    @Value("${eap.obpm.timeoutMillSecs:10000}")
    private int timeoutMillSecs; //milliseconds
    ...
    private String eapSign(String user){
        // change password when deploy to production
        return ObpmUtil.eapSign(user, obpmSignPassword);
    }
