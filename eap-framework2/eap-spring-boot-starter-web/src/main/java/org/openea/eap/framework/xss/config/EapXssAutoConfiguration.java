...
import static org.openea.eap.framework.web.config.EapWebAutoConfiguration.createFilterBean;

@AutoConfiguration
@EnableConfigurationProperties(XssProperties.class)
@ConditionalOnProperty(prefix = "eap.xss", name = "enable", havingValue = "true", matchIfMissing = true) // 设置为 false 时，禁用
public class EapXssAutoConfiguration implements WebMvcConfigurer {
